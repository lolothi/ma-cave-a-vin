    ...
    <div class="bg-blue-3 rounded-lg p-4 shadow-md flex justify-between">
      <div v-if="!editMode">
        ...
        <div>
          <div>
            ...
            <p><strong>Img :</strong> {{ wine?.picture_link }}</p>
            ...
            <p><strong>Note :</strong> {{ wine?.note }}</p>
      ...
      <div v-else>
        ...
        <div class="flex flex-end">
          <button @click="saveChanges" class="bg-blue-2 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Sauvegarder</button>
        </div>
      </div>
    </div>
  </div>
